...
import { ScrollDirection, isElement, generateUniqueId, getWindow, isSafari, DOMRectangle, Styles, getComputedStyles, isKeyboardEvent, parseTranslate, supportsPopover, showPopover, supportsStyle, animateTransform, cloneElement, ProxiedElements, canScroll, detectScrollIntent, scheduler, getScrollableAncestors, Listeners, scrollIntoViewIfNeeded, getDocument, isHTMLElement, isPointerEvent, PositionObserver } from '@dnd-kit/dom/utilities';
import { effects, effect, untracked, computed, deepEqual, batch, reactive, signal } from '@dnd-kit/state';
