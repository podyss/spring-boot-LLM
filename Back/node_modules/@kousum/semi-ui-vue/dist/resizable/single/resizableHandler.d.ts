...
export declare const vuePropsType: CombineProps<ResizableHandlerProps>;
declare const ResizableHandler: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
