...
export interface TableComponents {
    table?: DefineSetupFnComponent<HTMLAttributes & {
        className?: string;
    }>;
    header?: {
        outer?: DefineSetupFnComponent<HTMLAttributes & {
            className?: string;
        }>;
        wrapper?: DefineSetupFnComponent<HTMLAttributes & {
            className?: string;
        }>;
        row?: DefineSetupFnComponent<HTMLAttributes & {
            className?: string;
        }>;
        cell?: DefineSetupFnComponent<HTMLAttributes & {
            className?: string;
        }>;
    };
    body?: {
        ...
        colgroup?: {
            ...
            col?: DefineSetupFnComponent<HTMLAttributes & {
                className?: string;
            }>;
        };
    };
...
export type RowSelectionOnSelect<RecordType> = (record?: RecordType, selected?: boolean, selectedRows?: RecordType[], nativeEvent?: MouseEvent) => void;
