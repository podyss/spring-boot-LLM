import { ParsedEvents } from '@douyinfe/semi-foundation/lib/es/calendar/foundation';
...
declare const RangeCalendar: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    allDayEventsRender: PropType<(events: import("@douyinfe/semi-foundation/lib/es/calendar/foundation").EventObject[]) => import("../interface").VueJsxNode> | {
        type: PropType<(events: import("@douyinfe/semi-foundation/lib/es/calendar/foundation").EventObject[]) => import("../interface").VueJsxNode>;
        default?: any;
        required?: false;
    };
