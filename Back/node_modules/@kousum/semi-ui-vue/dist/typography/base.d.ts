...
import type { Ellipsis, TypographyBaseSize, TypographyBaseType } from './interface';
...
export declare const vuePropsType: CombineProps<BaseTypographyProps>;
